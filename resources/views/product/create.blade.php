            ...
            <form method="post" action="{{route('product.store')}}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="w-full flex flex-col">
                        ...
                        @enderror
                        <input type="text" name="title" class="w-auto py-2 placeholder-gray-300 border border-gray-300 rounded-md" id="title" value="{{old('title')}}" placeholder="title">
                    </div>
                    ...
                    <div class="w-full flex flex-col">
                        ...
                        @error('memo')
                            <p class="text-danger" style="color:red">{{$message}}</p>
                        @enderror
                        <textarea name="memo" class="form-control" id="body" cols="30" rows="10">{{old('memo')}}</textarea>
                    </div>
